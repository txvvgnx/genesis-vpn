...
var loginToggleVisibility = document.getElementById('toggleVisibility');
var loginVisiblilityState = 1;
loginToggleVisibility.onclick = function(e) {
  if(loginVisiblilityState == 0)
      loginVisiblilityState = 1;
  else if(loginVisiblilityState == 1)
      loginVisiblilityState = 0;

  changeVisibility(loginVisiblilityState, loginPassword, loginToggleVisibility);
};

function changeVisibility(visibilityState, passwordField, toggleVisibility) {
    if(visibilityState == 0) {
        passwordField.type = 'text';
        toggleVisibility.innerHTML = `<svg version="1.1" width="20px" height="20px" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
